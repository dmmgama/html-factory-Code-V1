...
4. **Editor** — recomenda ao David Gridstack (arrastar) vs. manifesto-em-texto, com
   trade-offs. Decisao e dele.
...
5. Manifesto (`workspace.json`) a comandar que blocos aparecem -> prova -> commit.
6. Folha de binding -> prova -> commit.
7. Editor (se decidido) -> prova -> commit.
