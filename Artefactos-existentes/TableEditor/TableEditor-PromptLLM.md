...
Este ficheiro é uma instrução para **converteres quaisquer dados**** (Excel/XLSX, CSV, JSON, tabelas coladas, texto…) — ou dados que utilizador descreva de raiz — para o **formato JSON exacto** que o a aplicação TableEditor consegue ingerir. Segue os passos da instrução
